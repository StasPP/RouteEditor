...
begin
  ...
  case SaveKind of
    0: SaveTXTFile(SaveTXTName, -1, MapFm.CoordSysN, RoutesBE.ItemIndex, DegFmt.ItemIndex, _RoutesRSpacer, True);
    1: SaveTXTMarkers(SaveTXTName, MapFm.CoordSysN, DegFmt.ItemIndex,{RoutesBE.ItemIndex,} _RoutesRSpacer,
...
begin
  ...
  DegFmt.Visible := CoordinateSystemList[MapFm.CoordsysN].ProjectionType = 0;
end;
