...
type
  TFTrackCS = class(TForm)
    ...
    procedure MrX_KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
  private
...
begin
  ...
  case ColsKind.ItemIndex of
     ...
     8: begin
        Min := MainTrack[0].RouteDist; Max :=  MainTrack[0].RouteDist;
        //isRnd.Checked := false;
     end;
  end;
  ...
  for I := 0 to Length(MainTrack) - 1 do
    case ColsKind.ItemIndex of
       ...
       8: begin
        if MainTrack[I].RouteDist < Min then
          Min :=  MainTrack[I].RouteDist;
        if MainTrack[I].RouteDist > Max then
          Max :=  MainTrack[I].RouteDist;
       end;
    end;
...
begin
  ...
  j := ColSKind.ItemIndex;
  for I := 0 to ColSKind.Items.Count - 1 do
    ColSKind.Items[I] := Inf[230+ I] ;
  ColSKind.ItemIndex := j;
end;
...
procedure TFTrackCS.MakeFloatSpins;
 ...
 var SPF :TFloatSpinEdit; s, s2:string; o:TWinControl; i:integer;
     e1, e2 : TNotifyEvent;  e3 : TKeyEvent;
 begin
    ...
    Try
      ...
      BEGIN
          ...
          begin
             ...
             e3 := TSpinEdit(Components[ObjI]).OnKeyDown;
             ...
             TFloatSpinEdit(Components[I]).OnKeyDown := e3;
...
procedure TFTrackCS.MrX_KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
