...
uses AsdbMap, MapFunctions, GoogleDownload, GeoFunctions, TabFunctions,
     ...
     DrawFunctions, GeoClasses, PointClasses;
...
begin
  ...
  Begin
    ...
    ///  Url :=    'https://static-maps.yandex.ru/1.x/?ll=37.620070,55.753630&size=450,450&z=13&l=map&pt=37.620070,55.753630,pmwtm1~37.64,55.76363,pmwtm99';
