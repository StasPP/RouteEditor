...
uses
  ...
  UMarkH in 'UMarkH.pas' {MarkH},
  UGroupKnotRenum in 'UGroupKnotRenum.pas' {Fknotgrouprenum},
  UGetMapPos in 'UGetMapPos.pas' {GetMapPos},
  UTrackCS in 'UTrackCS.pas' {FTrackCS},
  UCollapseFm in 'UCollapseFm.pas' {CollapseFm},
  UOpenKML in 'UOpenKML.pas' {KmlOpn};
...
begin
  ...
  Application.CreateForm(TMarkH, MarkH);
  Application.CreateForm(TFknotgrouprenum, Fknotgrouprenum);
  Application.CreateForm(TGetMapPos, GetMapPos);
  Application.CreateForm(TFTrackCS, FTrackCS);
  Application.CreateForm(TCollapseFm, CollapseFm);
  Application.CreateForm(TKmlOpn, KmlOpn);
  Application.Run;
end.
